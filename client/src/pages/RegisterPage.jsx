...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Registration successful! Welcome to FlowBit.");
      navigate("/dashboard");
    } catch (error) {
      toast.error(
        ...
        <div className="hidden lg:flex flex-col justify-center p-12 bg-gradient-to-br from-ink to-ink-secondary text-paper">
          ...
          >
            ...
            <p className="mt-4 text-paper/70 leading-relaxed">
              Create your account to unlock powerful insights and start managing
              your financial subscriptions with clarity and confidence. Your
              path to financial control starts now.
            </p>
          </motion.div>
        </div>
